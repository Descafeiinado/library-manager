...
/**
 * Exception thrown when a user attempts to loan a book that they have already loaned.
 * This ensures that users cannot have multiple active loans for the same book.
 */
